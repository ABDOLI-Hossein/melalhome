...
import FormRendering from "../../utils/formRendering";
...
function CreatePost2({user}) {
    ...
    const changeHandler = (e) => {
        ...
        if(e.target.name === 'file'){
          ...
          async function sendFile(){
            let {data} = await axios.post('http://localhost:3001/upload',file);
    ...
    const handleSubmit = (e) => {
        ...
        async function postData(){
            const res = await axios.post(`http://localhost:3001/${postType}`,dataToSubmit)
